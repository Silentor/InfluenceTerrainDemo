...
{
    public abstract class Network<TParent, TNode, TNodeData> : IEnumerable<TNode> where TNode : Network<TParent, TNode, TNodeData>.BaseNode
        where TParent : Network<TParent, TNode, TNodeData>
    {
        /// <summary>
        /// Find node by id
        /// </summary>
        ...
        public class BaseNode
        {
            ...
            public readonly IList<TNode> Neighbors = new List<TNode>();
        ...
        {
            private readonly Network<TParent, TNode, TNodeData> _parent;
            ...
            /// <param name="start"></param>
            public FloodFiller(Network<TParent, TNode, TNodeData> parent, TNode start, Predicate<TNode> searchFor = null)
            {
            ...
            /// <param name="parent"></param>
            /// <param name="start"></param>
            public FloodFiller(Network<TParent, TNode, TNodeData> parent, IEnumerable<TNode> start, Predicate<TNode> searchFor = null)
            {
